$(document).ready(function () {
  ...
  const docSidebarInitialExpand = function () {
    const toc = $('#toc')
    const active_cat = toc.data('nav-current-cat')
    const active_page = toc.data('nav-current-page')
    $('#cat-nav-id-'+active_cat).collapse("show")
    $('#doc-nav-id-'+active_page).collapse("show")
  }
