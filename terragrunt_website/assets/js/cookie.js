...
(function ($) { "use strict";
  var cookieInnerHtml = '<div><p>By using this website you agree to our <a href="/cookie-policy/">cookie policy</a></p><button id="cookieModalClose" class="btn btn-primary btn-sm">OK</button></div>';
